...
* Test Cases are documented in the sheet called [Best Buy Test Cases] in mentioned file [Instabug-Challenge.xlsx](Instabug-Challenge.xlsx) or URL [Instabug Challenge Documents](https://docs.google.com/spreadsheets/d/1gQblACTu6xv4WRJfd8lmyVmeO565SKkSTP15lHZghSI/edit?usp=sharing)
...
```
* Note that this project is out dated so you may face failures when start the project. following instructions may help:
   * If you face errors in npm install:
     Remove dependancy “sqlite3”, then npm install again and start the server
